...
- `NEXT_PUBLIC_TOURNAMENT_NAME`
- `NEXT_PUBLIC_COSMETICS_NAME`
...
- `NEXT_PUBLIC_TESTNET_TOURNAMENT_CONTRACT`
- `NEXT_PUBLIC_TESTNET_COSMETICS_CONTRACT`
...
- `NEXT_PUBLIC_MAINNET_TOURNAMENT_CONTRACT`
- `NEXT_PUBLIC_MAINNET_COSMETICS_CONTRACT`
...
NEXT_PUBLIC_MAINNET_COIN_FLIP_CONTRACT=SP2J7...MAINNET.coin-flip-v9
NEXT_PUBLIC_MAINNET_TOURNAMENT_CONTRACT=SP2J7...MAINNET.tournament-v9
NEXT_PUBLIC_MAINNET_COSMETICS_CONTRACT=SP2J7...MAINNET.cosmetics-v9
```
